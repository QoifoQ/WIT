...
## WIT estimator with a predetermined initial points and a fiexed tuning parameter lambda
WIT = function(D,Y,Z,beta_old,lambda,kappa=0.5,error_c=1e-3,error_t=1e-5)
{
  ...
  xxx = ivmodel(Y,D,Z[,valid_index],Z[,invalid_index],intercept=FALSE,beta0=1,alpha=0.05,manyweakSE=TRUE,heteroSE=FALSE,clusterID=NULL)
